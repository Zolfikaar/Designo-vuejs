  ...
  <footer>
    <div class="nav-container">
      ...
      <div class="top-links navbar">
        ...
        <div class="navs">
          <ul>
            <li><RouterLink to="/our-company">Our Company</RouterLink></li>
            <li><RouterLink to="/locations">Locations</RouterLink></li>
...
footer .down-links > div > p{
  opacity: .5;
  font-weight: bold;
  margin-bottom: 5px;
}
footer .down-links .company-info p:nth-child(2),
footer .down-links .company-info p:last-child{
  font-weight: normal;
}

footer .down-links .company-socials{
  margin-bottom: 12px;
}
footer .down-links .company-socials a{
  margin-left: 20px;
}
footer .down-links .company-socials a svg path{
  fill: var(--clr-primary);
}
footer .down-links .company-socials a svg path:hover{
...
@media screen and (min-width: 375px) and (max-width: 768px){
  ...
  footer .down-links .company-contact{
    margin: 40px 0;
  }
}
</style>